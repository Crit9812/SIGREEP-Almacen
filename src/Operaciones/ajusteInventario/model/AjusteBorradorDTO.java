...
public class AjusteBorradorDTO implements Serializable {
    private static final long serialVersionUID = 1L;

    private String comentario;
    private List<ItemEntradaPlano> entradas;
    private List<ItemSalidaPlano> salidas;

    // Getters y setters
    public String getComentario() { return comentario; }
    public void setComentario(String comentario) { this.comentario = comentario; }

    public List<ItemEntradaPlano> getEntradas() { return entradas; }
    public void setEntradas(List<ItemEntradaPlano> entradas) { this.entradas = entradas; }

    public List<ItemSalidaPlano> getSalidas() { return salidas; }
    public void setSalidas(List<ItemSalidaPlano> salidas) { this.salidas = salidas; }

    // --- Clases internas para items planos ---

    public static class ItemEntradaPlano implements Serializable {
        private static final long serialVersionUID = 1L;
        ...
        // Getters y setters (generados automáticamente en IDE)
    ...
    public static class ItemSalidaPlano implements Serializable {
        private static final long serialVersionUID = 1L;
